...
<%
	...
	/* 원래는 try-catch 줘야 하지만 수업 보기 편하라고 패스 나중에할땐 넣어야 함. */
	conn = util.open();
	...
	<main>
		...
		<section>
			<div class="section content">
				...
				<div class="btns">
					<input type="button" value="추가하기" class="btn btn-primary" onclick="location.href='add.jsp';">
				</div>
			</div>
		</section>
	</main>
